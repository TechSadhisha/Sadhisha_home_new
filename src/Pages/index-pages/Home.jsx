          ...
          <div className="d-flex flex-column justify-content-md-between justify-content-center welcome-message">
            <div className="heading-contet flex-row-center row mx-md-0 mx-1">
              ...
              <p className="paraWhite col-md-9 text-center">
                Sadhisha has been transforming India’s Real Estate — creating
                residential, commercial, industrial and institutional projects
                that blend modern living with sustainability, reflecting our
            ...
            <div className="row justidy-content-center align-items-center d-flex text-center">
              {dataStats.map((item, index) => (
                <div className="col-md-3 mb-md-1 mb-4" key={index}>
                  ...
                  <p className="count-label paraBlack text-center">
                    {item.label}
                  </p>
                </div>
              ))}
      ...
      <div className="bgGreen px-md-0 px-2 py-md-0 py-3">
        ...
        <Section>
          ...
          <div className="row justify-content-center">
            {sadhishaPromoters.map((category, index) => (
                ...
                >
                  ...
                  <div className="service-body">
                    ...
                    {category.services.map((service, index) => (
                      <li
                        className="list-unstyled paraBlack  ms-1 mb-2 text-start"
                        key={index}
                      >
                        <BsBuildings className="fs-6 me-2" />
                        {service}
                      </li>
                    ))}
                  </div>
        ...
        <Section>
          ...
          <div className="row justify-content-center">
            {auroArchitects.map((category, index) => (
              <div className="col-md-4">
                <div
                  key={index}
                  className="rounded-2 services-category-card mb-md-4 mb-3 "
        ...
        <Section>
          ...
          <div className="row justify-content-center">
            {sadhishaRapidConstruction.map((category, index) => (
              <div className="col-md-4">
                <div
                  key={index}
                  className="rounded-2 services-category-card mb-md-4 mb-3 "
        ...
        <Section>
          ...
          <div className="row justify-content-center">
            {sadhishaInteriors.map((category, index) => (
              <div className="col-md-4">
                <div
                  key={index}
                  className="rounded-2 services-category-card mb-md-4 mb-3 "
        ...
        <Section>
          ...
          <div className="row justify-content-center">
            {sadhishaHospitality.map((category, index) => (
              <div className="col-md-4">
                <div
                  key={index}
                  className="rounded-2 services-category-card mb-md-4 mb-3 "
      ...
      <div className="bgWhite px-4 px-md-2 py-md-5 py-5">
            ...
            <div className="department-card mb-4" key={index}>
              <div className="position-relative department-image-wrapper">
                ...
                <div className="department-overlay-content">
                  <h3 className="department-overlay-title subTitleWhite">
                    {department.title}
                  </h3>
                  <p className="department-overlay-description paraWhite">
        ...
        <div className="row flex-row-center">
          <p className="paraBlack col-md-10 text-center">
            At Sadhisha, we don’t just build structures—we build a seamless
            ecosystem where every stage of real estate development is managed
            in-house with precision, passion, and purpose. From land acquisition
            and financial planning to architectural design, construction,
            marketing, and after-sales support—our integrated model ensures
            efficiency, transparency, and exceptional value for every
            stakeholder. Explore the divisions that power our promise of
            excellence:
          </p>
        </div>
        <div className="row flex-row-center">
      ...
      <div className="bgWhite px-md-0 px-2 py-md-0 py-3">
        <Section>
          <div className="mb-md-4 mb-5 row flex-row-center">
            ...
            <p className="subParaTextGreen text-uppercase mb-md-4 mb-2  text-center">
              {" "}
              Sustainable. Ethical. Client-Focused.
            </p>
          </div>
          <div className="row justify-content-center">
            {pillars.map((pillar, index) => (
              <div className="col-md-3 col-sm-6 mb-4" key={index}>
                <div className="position-relative">
                  ...
                  <p className="mt-3 paraBlack text-center">
                    {pillar.description}
                  </p>
                </div>
              </div>
