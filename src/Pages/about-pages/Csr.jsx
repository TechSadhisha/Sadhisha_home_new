          ...
          <div className="row align-items-center justify-content-between">
            ...
            <div className="col-md-5 mb-4 mb-md-0">
              ...
              <p className="paraBlack mt-3">
                At Sadhisha, we believe that great architecture is not just
                about structures—but about harmony with nature. As one of
                India’s Top 10 Sustainable Design Firms, we bring over 30 years
                of rich experience in crafting eco-architecture that blends
                aesthetics, function, and environmental responsibility. <br />
                From eco-friendly homes, schools, and workplaces to hotels,
                resorts, campuses, and institutions, our projects reflect a
                commitment to green living and long-term well-being. Every
                structure is thoughtfully designed to reduce environmental
                impact while enhancing user comfort and energy efficiency.
              </p>
            ...
            <div className="py-md-5 py-5">
              <h4 className="subTitleGreen mb-md-5 mb-5 fs-3 text-md-start text-center">
                {" "}
              ...
              <div className="row justify-content-evenly">
                <div className="col-md-3 mb-md-0 mb-3">
                  <div className="mission-vision-card">
                    ...
                    <h4 className="subTitleBlack mb-md-4 text-center mb-2 fs-5">
                ...
                <div className="col-md-3">
                  <div className="mission-vision-card">
                    ...
                    <h4 className="subTitleBlack mb-md-4 text-center mb-2 fs-5">
                      Climate-responsive designs that respect local ecosystems
                    </h4>
                  </div>
                </div>
              </div>
      ...
      <div className="bgGreen py-md-0 py-3 px-md-0 px-2">
        <Section>
          <div className="row align-items-center justify-content-between">
            {/* Left Side Content */}
            <div className="col-md-5 mb-4 mb-md-0">
              <h2 className="secTitleWhite text-md-start text-center">
                Sadhisha Charitable Trust
              </h2>
              ...
              <p className="paraWhite mt-3">
                Driven by a deep commitment to social upliftment, Mr. Bipin
                Rananaware founded the Sadhisha Charitable Trust as the
                philanthropic arm of Sadhisha Homes. Guided by his vision of
                inclusive growth, the Trust actively engages in initiatives that
                support the health, dignity, and well-being of underprivileged
                communities.
              </p>
              <a
                href="#contact-section"
                className="btn white-btn d-md-block d-none mt-4"
              >
                Join Us
              </a>
            </div>
            ...
            <div className="col-md-7 p-md-4">
              ...
              <div className="row d-flex justify-content-center d-md-none py-4">
                <a className="btn white-btn mt-4">LEARN MORE</a>
              </div>
            </div>
            ...
            <div className=" py-md-5 py-3">
              <h4 className="subTitleWhite  mb-md-5 mb-3 fs-3 text-md-start text-center">
                {" "}
              ...
              <div className="col-md-7">
                <div className="pb-md-4 pb-2">
                  ...
                  <p className="paraBlack col-md-10 text-md-start text-center">
                    Whether you’re exploring property options, seeking
                    partnership, or have a general enquiry.
                  </p>
                </div>
                  ...
                  <div className="py-md-2 col-md-5 ">
                    <div className="contact-card">
                      ...
                      <ul>
                        <p className="paraBlack">
                          Sadhisha, <br />
                          Workafella IFL TOWERS Perungudi, OMR
                          <br />
