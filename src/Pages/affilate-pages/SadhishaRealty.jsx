...
const SadhishaRealityImage =
  cloudinaryAssets["src/assets/images/our_companies/sadhisha_reality.webp"];
const Reality2 =
  cloudinaryAssets["src/assets/images/our_companies/reality2.webp"];
const Reality3 =
  cloudinaryAssets["src/assets/images/our_companies/reality3.webp"];

const SadhishaRealty = () => {
  useEffect(() => {
        ...
        <Section>
          ...
          <div className="row flex-row-center pt-md-5 pt-3">
            <p className="paraBlack col-md-10 text-md-center px-4 px-md-0">
              We specialize in creating sustainable, human-centered spaces—from
              eco-friendly homes and smart workplaces to educational campuses,
              institutions, hotels, and resorts. Every structure we build is
              thoughtfully designed to promote comfort, health, and harmony with
              nature, while meeting the evolving needs of modern living.
            </p>
          </div>
        </Section>
      </div>
        ...
        <Section>
          ...
          <div className="row flex-row-center pt-md-5 py-3">
            <p className="paraWhite col-md-10 text-center px-4 px-md-0">
              With over 24 years of experience, 250+ successful project
              handovers, and more than 10,000 satisfied residents, Sadhisha
              Homes continues to lead the way in delivering thoughtful,
              sustainable spaces that improve lives. We specialize in designing
              and constructing a wide range of eco-conscious buildings,
              including:
            </p>
          </div>
        </Section>
