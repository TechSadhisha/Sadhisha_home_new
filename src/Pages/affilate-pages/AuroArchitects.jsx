...
import AuroArchitect2 from "../../assets/images/our_companies/architect2.jpg";
import AuroArchitect3 from "../../assets/images/our_companies/architect3.jpg";
        ...
        <Section>
          ...
          <div className="row flex-row-center pt-md-5 pt-3">
            <p className="paraBlack col-md-10 text-md-center px-4 px-md-0">
              Auro Architects is the creative design force behind many of
              Sadhisha’s most iconic projects. Recognized as one of India’s Top
              10 Sustainable Design Firms, Auro brings over 30 years of
              experience in delivering world-class architecture that blends
              innovation with environmental responsibility. With a philosophy
              rooted in architecture in harmony with nature, Auro Architects
              specializes in eco-architecture, urban planning, interior design,
              and landscape development. Their approach balances functionality,
              aesthetics, and sustainability—creating spaces that are not only
              beautiful but deeply meaningful and future-ready. Whether it’s
              residential communities, institutional campuses, resorts, or
              mixed-use developments, Auro Architects continues to set
              benchmarks for responsible, human-centered design.
            </p>
          </div>
        </Section>
      </div>
          ...
          <div className="row justify-content-center md-md-0">
            <div className="flex-row-center row mb-md-5 mb-3">
              ...
              <p className="paraBlack col-md-9 text-center">
                At Sadhisha and Auro Architects, we combine aesthetics with
                purpose—delivering spaces that are innovative, functional, and
                timeless. Our multi-disciplinary expertise ensures that every
                element of the built environment is thoughtfully crafted and
            ...
            <div className="row justify-content-center pb-md-5">
              {specializationData.map((specialization, index) => (
                <div
                  className="col-md-4 mb-md-4 mb-5 pb-md-0 pb-5 d-flex justify-content-center"
                  key={index}
                >
                  <div className="hexagon-card">
                    <div className="hexagon-card-content px-4 py-3">
                      ...
                      <p className="fs-6 paraWhite text-center">
