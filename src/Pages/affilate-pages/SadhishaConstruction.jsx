...
const dummy2 = cloudinaryAssets["src/assets/images/home/dummy1.webp"];
const dummy1 = cloudinaryAssets["src/assets/images/home/dummy2.webp"];
...
const SadhishaConstructionImage =
  cloudinaryAssets["src/assets/images/our_companies/construction.webp"];
const Construction2 =
  cloudinaryAssets["src/assets/images/our_companies/construction2.webp"];
const Construction3 =
  cloudinaryAssets["src/assets/images/our_companies/construction3.webp"];
        ...
        <Section>
          ...
          <div className="row flex-row-center pt-md-5 pt-3">
            <p className="paraBlack col-md-10  text-md-center px-4 px-md-0">
              At Sadhisha Construction Technologies, we blend engineering
              excellence with modern innovations to transform how spaces are
              imagined and built. Our approach prioritizes speed, strength,
              sustainability, and design flexibility—empowering developers and
              businesses to build better, faster, and smarter.
            </p>
          </div>
        </Section>
      </div>
        ...
        <Section>
          <div className="row align-items-center justify-content-between">
            <div className="col-md-5 mb-4 mb-md-0">
              ...
              <p className="subParaTextWhite text-uppercase mb-md-4 mb-4 text-md-start text-center">
                Build Your Future While Building Others’ Dreams
              </p>
              <p className="paraWhite mt-3  px-4 px-md-0">
                A breakthrough in modern construction, the Rapid Building System
                uses light gauge steel structures instead of traditional steel
                or concrete frameworks.
              </p>
        ...
        <Section>
          <div className="row justify-content-center md-md-0">
            <div className="flex-row-center row mb-md-5 mb-3">
              ...
              <p className="subParaGreen text-uppercase mb-md-4 mb-4 text-center">
              ...
              {whyChooseSadhishaConstruction.map((benefit, index) => (
                ...
                >
                  <div className="benefit-card">
                    ...
                    <p className="paraBlack fs-6 text-center mb-md-3">
                      {benefit.description}
                    </p>
                  </div>
                </div>
