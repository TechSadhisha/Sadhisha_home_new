    ...
    >
      <div className="align-items-center d-flex flex-column w-100 justify-content-center">
        <div className="w-100 px-3 d-flex justify-content-between align-items-center">
          <a
            className="navbar-brand mx-md-auto"
            href="/"
        ...
        >
          <div className="offcanvas-body d-flex flex-column flex-lg-row justify-content-lg-start me-5">
            ...
            <ul className="navbar-nav gap-3">
              ...
              <li className="nav-item">
                <Link to="/ongoing-projects" className="nav-link">
                  Ongoing Projects
                </Link>
              </li>
                ...
                >
                  {[
                    ...
                    { path: "/auro-architects", label: "Auro Architects" },
                    {
                      ...
                      label: "Sadhisha Construction Technologies",
                    },
                    { path: "/sadhisha-homes", label: "Sadhisha Homes" },
                    {
                      path: "/sadhisha-rapid-edge",
                      label: "Sadhisha Rapid Edge",
                    },
                    {
                    ...
                    <li key={path}>
                      <a
                        ...
                        href={path}
                        onClick={(e) =>
                          handleNavClick(e, path, affiliates.close)
                        }
                      >
                        {label}
                      </a>
                ...
                <ul className={`dropdown-menu ${isAboutOpen ? "show" : ""}`}>
                  <li>
                    <a
                      href="/about"
                      className="dropdown-item"
                      onClick={(e) => handleNavClick(e, "/about", about.close)}
                    >
                      About Us
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      className="dropdown-item"
                      onClick={(e) =>
                        handleNavClick(e, "/recognition", about.close)
                      }
                    >
                      Awards & Recognition
                    </a>
                ...
                <ul className={`dropdown-menu ${isJoinOpen ? "show" : ""}`}>
                  <li>
                    <a
                      href="/careers"
                      className="dropdown-item"
                      onClick={(e) => handleNavClick(e, "/careers", join.close)}
                    >
                      Careers
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      className="dropdown-item"
                      onClick={(e) =>
                        handleNavClick(e, "/channel-partners", join.close)
                      }
                    >
                      Channel Partners
                    </a>
